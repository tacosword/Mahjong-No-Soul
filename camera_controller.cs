...
public class CameraController : MonoBehaviour
{
    ...
    private void TrySetupCamera()
    {
        ...
        int seat = localPlayer.PlayerIndex;
        ...
        Vector3[] positions = { 
            ...
            new Vector3(0, 1.77f, 3.88f), // Seat 2 (North) - Faces South 
            new Vector3(-0.88f, 1.77f, 1.59f) // Seat 3 (East) - Faces West 
        };
        ...
        if (seat >= 0 && seat < positions.Length)
        {
            ...
            cameraSetup = true; // Stop trying after success
        }
    }
}